<%@ Page Title="Autenticação de dois fatores" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="HackatonDisciplinas.TwoFactorAuthenticationSignIn" %>
    ...
    <main aria-labelledby="title">
        ...
        <asp:PlaceHolder runat="server" ID="sendcode">
            <section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        Selecione o provedor de autenticação de dois fatores:
            ...
            <section>
                ...
                <div class="form-group">
                    <div class="offset-md-2 col-md-10">
                        <div class="checkbox">
                            <asp:Label Text="Lembrar-se do navegador" runat="server" />
