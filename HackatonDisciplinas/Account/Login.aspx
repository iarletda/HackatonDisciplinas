<%@ Page Title="Logon" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Login.aspx.vb" Inherits="HackatonDisciplinas.Login" Async="true" %>
            ...
            <div class="col-md-8">
                <section id="loginForm">
                    <div>
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-10">
                                <asp:Button runat="server" OnClick="LogIn" Text="Logon" CssClass="btn btn-outline-dark" />
                            </div>
                        </div>
                    </div>
                    <p>
