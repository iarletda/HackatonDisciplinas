<%@ Page Title="" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ManageLogins.aspx.vb" Inherits="HackatonDisciplinas.ManageLogins" %>
<%@ Register Src="~/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <h2 id="title">Gerencie seus logons externos.</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" Text="Remover" CommandName="Delete" CausesValidation="false"
                                    ToolTip='<%# "Remover este " + Item.LoginProvider + " logon de sua conta" %>'
